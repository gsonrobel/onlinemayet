...
const ProductEditScreenSaler = ({ match, history }) => {
  ...
  useEffect(() => {
    if (successUpdate) {
      ...
      history.push('/saler/productlist');
  ...
  return (
    <>
      <Link to='/saler/productlist' className='btn btn-light my-3'>
        Go Back
      </Link>
      <FormContainer>
        <h1>Edit Product</h1>
        ...
        {loading ? (
          ...
          <Form onSubmit={submitHandler}>
            ...
            <Form.Group controlId='imagetwo'>
              ...
              <Form.Control
                type='text'
                placeholder='Enter imagetwo url'
                value={imagetwo}
...
export default ProductEditScreenSaler;
